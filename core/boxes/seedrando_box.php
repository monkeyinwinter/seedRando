 ...
 */
class seedrandobox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "seedrando@seedrando";
    public $boxlabel;
    public $depends = array("seedrando");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/seedrando/class/seedrando.class.php";
